             ...
             $.ajax({
                ...
                success: function (data) {
                    ...
                    if (res.status == "success") { // 如果成功
                        ...
                        if( thisShareNoteDefault == undefined) {
                            thisShareNoteDefault = [];
                        }
                        var isSharedAlready = 0;
                        for(var i in thisShareNoteDefault) {
                            var curShareNoteData = thisShareNoteDefault[i];
                            if(i.NoteId == shareData.NoteId) {
