...
//        alert("inside a");
        ...
        if (N) {
            ...
            if (i = "inner" == n ? N: N.getParentNode()) {
                ...
                curNotebook.ParentNotebookId = parentNotebookId;
...
//        alert("UserId Id is" + n);  
    ...
    var s = {
        ...
        callback: {
            beforeDrag: N,
            beforeDrop: n,
            onDrop: a, // drop时的回调函数。用于将notebook拖进另一个notebook
            onClick: i, // 点击时的回调函数
            onDblClick: k,
...
//    if(trash != undefined && t != undefined) {
//        o.splice(indexOfTrash, indexOfTrash);
...
//
    ...
    var temp = clone(o);
    e.tree = $.fn.zTree.init($("#notebookList"), e.getTreeSetting(), o); // initialize the zTree
...
//        })
        for(var i in sharedUserInfos) {
            if(sharedUserInfos[i].UserId == t) {
                sharedUserInfos.splice(i,1);
            }
        }
        t && $(e).parent().remove();
    }
...
function onbeforeunload_handler(){
    ...
    saveIntoLocal();
    Server.uploadToServer();
    var warning = "We will help you synchronize, dont worry :)";              
    return warning;
