...
//          如果change了，返回一个object（包含当前changed note的信息）
Note.curHasChanged = function(t) {
    ...
    var i = !1;
    if ((e.IsNew || t || !Note.readOnly) && (i = !0), !n.hasChanged && !i) return ! 1; // !1 == false
    if (!i) return n;
...
// 表面的保存：只是将changed note保存到cache里
// t是个boolean值
// e是个function
...
Note.curChangedSaveIt = function(t, e) {
    ...
    if (Note.curNoteId && !Note.isReadOnly) {
        var a;
        try {
            a = Note.curHasChanged(t) // a是个boolean值或者一个object
        } catch(n) {
            return void(e && e(!1))
        }
        ...
        function(t) {
            o.saveInProcess[a.NoteId] = !1, // 对应的id存下：true（表示需要save）
...
function initPage() {
    if (Notebook.renderNotebooks(notebooks), // 这里的notebooks变量定义在主页里
        ...
        Share.firstRenderShareNote(curSharedUserId, curSharedNoteNotebookId, curNoteId) : (Note.setNoteCache(noteContentJson), // noteContentJson变量定义在主页：是当前note内容
