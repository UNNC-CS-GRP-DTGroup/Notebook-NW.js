...
function initPage() {
    ...
    }), curNotebookId || Notebook.selectNotebook($(tt('#notebook [notebookId="?"]', Notebook.allNotebookId))))), latestNotes.length > 0) {
        for (var e = 0; e < latestNotes.length; ++e) Note.addNoteCache(latestNotes[e]);
    }
