...
//                trackingLog = {}; // once uploaded successfully, delete the local one
            },
...
function maxLeft(e) {
    ...
    $("#noteAndEditor").css("left", 200),
    $("#leftNotebook").width(200),
    resizeEditor();
    e && updateLeftIsMin(!1)
}
...
function addShareNoteOrNotebook(e) {
    var t = "#tr" + e,
    o = Share.dialogNoteOrNotebookId, // 要share的note或notebook的ID
    emailAddress = isEmailFromInput(t + " #friendsEmail", "#shareMsg", getMsg("inputFriendEmail")); // input emial address
    if (emailAddress) {
        var a = $(t + ' input[name="perm' + e + '"]:checked').val() || 0, // a通常为0
        n = a,
        ...
        Share.dialogIsNote || (s = "/share/addShareNotebook", i = { // 如果share的是notebook
            notebookId: o,
            email: emailAddress,
            perm: a
        }),
...
Share.changeNotebook = function(e, t, o) {
    ...
    ajaxGet(n, s, // 如果目标notebook不是default，s.notebookId这位目标notebookId，否则为空
