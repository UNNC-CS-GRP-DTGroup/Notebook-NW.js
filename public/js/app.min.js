...
Server.uploadToServer = function() {
    allDataTogether = UserInfo;
//    allDataTogether.Notebooks = Notebook.cache;
//    allDataTogether.CurNoteId = Note.curNoteId;
//    allDataTogether.CurNotebookId = Note.curNotebookId;
//    allDataTogether.Notes = Note.cache;
//    allDataTogether.LatestNotes = Note.cache;
//    allDataTogether.TagsJson = tagsJson;
    allDataTogether.TagsJson = {};
    allDataTogether.CurNotebookId = "";
    
    var stringifiedJson = JSON.stringify(allDataTogether);
    var improved = stringifiedJson.
    
    $.ajax({
        type: 'POST', // added,
        url: 'http://cs-linux.nottingham.edu.cn:8080',
...
$(function() {
    ...
    $("#addBtn").click(function() {
        $('#editor').append("<div class = \"drggableDiv\" draggable=true contenteditable=true> new paragraph </div>");
...
var Resize = {
    ...
    set3ColumnsWidth: function(e, t) {
        var o = this;
        if (! (150 > e || 100 > t)) { //当e >= 150 && t >= 100时执行
