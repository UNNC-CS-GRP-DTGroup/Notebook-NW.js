...
Note.curHasChanged = function(t) {
    ...
    var i = !1;
    if ((e.IsNew || t || !Note.readOnly) && (i = !0), !n.hasChanged && !i) return ! 1;
    if (!i) return n;
...
Note.curChangedSaveIt = function(t, e) {
    ...
    if (Note.curNoteId && !Note.isReadOnly) {
        var a;
        try {
            a = Note.curHasChanged(t)
        } catch(n) {
            return void(e && e(!1))
        }
        return a && a.hasChanged ? (log("需要保存..."), Note.renderChangedNote(a), delete a.hasChanged, showMsg(getMsg("saving")), o.saveInProcess[a.NoteId] = !0, ajaxPost("/note/updateNoteOrContent", a,
        function(t) {
            o.saveInProcess[a.NoteId] = !1,
            a.IsNew && (t.IsNew = !1, Note.setNoteCache(t, !1), Pjax.changeNote(t)),
            e && e(),
            showMsg(getMsg("saveSuccess"), 1e3)
        }), void 0 != a.Tags && "string" == typeof a.Tags && (a.Tags = a.Tags.split(",")), Note.setNoteCache(a, !1), Note.setNoteCache({
            NoteId: a.NoteId,
...
Note.renderNotes = function(t, e, o) {
    ...
    if (this.clearSeqForNew(), this.batch.reset(), LEA.isMobile || Mobile.isMobile() || $("#noteItemList").slimScroll({
        scrollTo: "0px",
        height: "100%",
        onlyScrollBar: !0
...
$(function() {
    ...
    $("#addBtn").click(function() {
        $('#editor').append("<div draggable=true contenteditable=true> new paragraph </div>")
        tinymce.init({
          selector: '#editor div',
          inline: true,
          plugins: [
...
function initPage() {
    if (Notebook.renderNotebooks(notebooks), Share.renderShareNotebooks(sharedUserInfos, shareNotebooks), curSharedNoteNotebookId ? Share.firstRenderShareNote(curSharedUserId, curSharedNoteNotebookId, curNoteId) : (Note.setNoteCache(noteContentJson), Note.renderNotes(notes), curNoteId && (setTimeout(function() {
        Note.changeNoteForPjax(curNoteId, !0, curNotebookId)
    }), curNotebookId || Notebook.selectNotebook($(tt('#notebook [notebookId="?"]', Notebook.allNotebookId))))), latestNotes.length > 0) for (var e = 0; e < latestNotes.length; ++e) Note.addNoteCache(latestNotes[e]);
...
Notebook.getTreeSetting = function(o, e) {
    ...
    var r = !o,
    b = this;
    if (e) var i = function(o, e, t) {
        var N = t.NotebookId,
        n = $(o.target).closest(".friend-notebooks").attr("fromUserId");
...
Notebook.changeNotebook = function(o, e) {
    ...
    n = {};
        ...
        if (n = {},
        cacheNotes = Note.getNotesByNotebookId(), !isEmpty(cacheNotes)) return void(e ? e(cacheNotes) : Note.renderNotesAndFirstOneContent(cacheNotes))
    } else {
        cacheNotes = Note.getNotesByNotebookId(o);
        var a = Notebook.cache[o],
        r = cacheNotes ? cacheNotes.length: 0;
        if (r == a.NumberNotes) return void(e ? e(cacheNotes) : Note.renderNotesAndFirstOneContent(cacheNotes));
