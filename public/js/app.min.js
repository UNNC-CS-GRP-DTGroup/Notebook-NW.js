...
Note.curChangedSaveIt = function(t, e) {
    ...
    if (Note.curNoteId && !Note.isReadOnly) {
        var a;
        try {
            a = Note.curHasChanged(t) // a是个boolean值（当前note没变）或者一个object（已改变的note）
        } catch(n) {
            return void(e && e(!1))
        }
        return a && a.hasChanged ? //如果已改变
            ...
            void 0 != a.Tags && "string" == typeof a.Tags && (a.Tags = a.Tags.split(",")), Note.setNoteCache(a, !1), 
            Note.setNoteCache({NoteId: a.NoteId,
